...
export const CHAPTERS: Chapter[] = [
  ...
  },
  {
    ...
    lessons: [
      ...
      {
        id: "ch10-l2",
        title: "Diseno de modulos y bundlers",
        xpReward: 35,
        sections: [
          {
            id: "ch10-l2-s1",
            title: "Diseno de modulos",
            content: "Un buen modulo es facil de usar y tiene una interfaz clara. Debe hacer una sola cosa bien. Los modulos compuestos (que importan y re-exportan otros) permiten crear APIs limpias. Evita dependencias circulares entre modulos.",
          },
          {
            id: "ch10-l2-s2",
            title: "Bundlers y herramientas de compilacion",
            content: "Los bundlers (como Webpack, esbuild, Vite) empaquetan multiples modulos en un solo archivo para el navegador. Tambien pueden transpilar (convertir) codigo moderno a versiones anteriores de JavaScript para compatibilidad. NPM es el ecosistema de paquetes mas grande del mundo.",
          },
        ],
        exercises: [
          {
            id: "ch10-l2-e1",
            type: "multiple-choice",
            question: "Que hace un bundler?",
            options: [
              "Empaqueta multiples modulos en un solo archivo",
              "Ejecuta codigo en el servidor",
              "Crea bases de datos",
              "Dibuja graficos en canvas",
            ],
            correctAnswer: "Empaqueta multiples modulos en un solo archivo",
            explanation: "Un bundler toma multiples archivos de modulos y sus dependencias y los combina en uno o pocos archivos para el navegador.",
            xpReward: 15,
          },
          {
            id: "ch10-l2-e2",
            type: "true-false",
            question: "Los modulos deben evitar dependencias circulares (A importa B, B importa A).",
            options: ["Verdadero", "Falso"],
            correctAnswer: "Verdadero",
            explanation: "Las dependencias circulares pueden causar problemas de inicializacion y hacen el codigo mas dificil de entender.",
            xpReward: 10,
          },
        ],
      },
  ...
  },
  {
    ...
    lessons: [
      ...
      {
        id: "ch13-l2",
        title: "Compatibilidad y sandbox",
        xpReward: 35,
        sections: [
          {
            id: "ch13-l2-s1",
            title: "Compatibilidad entre navegadores",
            content: "Diferentes navegadores (Chrome, Firefox, Safari, Edge) pueden implementar funciones de forma diferente. Los estandares web (HTML, CSS, JS) son definidos por organizaciones como W3C y TC39. Siempre verifica la compatibilidad de funciones nuevas en caniuse.com.",
          },
          {
            id: "ch13-l2-s2",
            title: "El sandbox del navegador",
            content: "El navegador ejecuta JavaScript en un entorno aislado (sandbox) por seguridad. Los scripts no pueden leer archivos del disco, no pueden acceder a paginas de otros dominios (same-origin policy), y tienen acceso limitado a APIs del sistema. Esto protege al usuario de codigo malicioso.",
          },
        ],
        exercises: [
          {
            id: "ch13-l2-e1",
            type: "multiple-choice",
            question: "Que es la same-origin policy?",
            options: [
              "Una restriccion que impide acceder a datos de otros dominios",
              "Una forma de compartir datos entre paginas",
              "Un protocolo de red",
              "Un tipo de cookie",
            ],
            correctAnswer: "Una restriccion que impide acceder a datos de otros dominios",
            explanation: "La same-origin policy es una medida de seguridad del navegador que impide que scripts de un sitio accedan a datos de otro sitio.",
            xpReward: 15,
          },
          {
            id: "ch13-l2-e2",
            type: "true-false",
            question: "JavaScript en el navegador puede leer cualquier archivo del disco duro del usuario.",
            options: ["Verdadero", "Falso"],
            correctAnswer: "Falso",
            explanation: "El sandbox del navegador prohibe el acceso al sistema de archivos por seguridad. Solo se pueden leer archivos que el usuario seleccione explicitamente.",
            xpReward: 10,
          },
        ],
      },
  ...
  },
  {
    ...
    lessons: [
      {
        id: "ch16-l1",
        title: "Niveles y actores",
        xpReward: 40,
        sections: [
          {
            id: "ch16-l1-s1",
            title: "Representacion de niveles",
            content: "El juego usa una cadena de texto para representar cada nivel. Cada caracter define un tipo de celda: '.' es espacio vacio, '#' es muro, '+' es lava, '@' es la posicion inicial del jugador, 'o' son monedas. El constructor Level parsea esta cadena en una cuadricula 2D.",
            codeExample: "let simpleLevelPlan = `\n......................\n..#................#..\n..#..............=.#..\n..#.........o.o....#..\n..#.@......#####...#..\n..#####............#..\n......#++++++++++++#..\n......##############..\n......................`;\n\nclass Level {\n  constructor(plan) {\n    let rows = plan.trim().split('\\n').map(l => [...l]);\n    this.height = rows.length;\n    this.width = rows[0].length;\n    // parsear actores y cuadricula...\n  }\n}",
          },
          {
            id: "ch16-l1-s2",
            title: "Actores del juego",
            content: "Los actores son objetos moviles: el jugador, las monedas y la lava. Cada actor tiene una posicion (Vec), tamano y velocidad. La lava puede ser estatica, que rebota horizontalmente (=), o que gotea (v). Las monedas se mueven arriba y abajo con un efecto de balanceo.",
        ...
        exercises: [
          ...
          },
          {
            id: "ch16-l1-e2",
            type: "multiple-choice",
            question: "En el juego, que caracter representa la posicion inicial del jugador?",
            options: ["@", "#", "o", "+"],
            correctAnswer: "@",
            explanation: "@ marca donde aparece el jugador. # es muro, o son monedas y + es lava.",
            xpReward: 15,
          },
        ],
      },
      {
        id: "ch16-l2",
        title: "Motor de juego y display",
        xpReward: 45,
        sections: [
          {
            id: "ch16-l2-s1",
            title: "Deteccion de colisiones",
            content: "El motor de juego actualiza el estado en cada frame. Detecta colisiones entre el jugador y los muros/lava/monedas. Tocar lava reinicia el nivel, recoger todas las monedas completa el nivel. La gravedad tira al jugador hacia abajo, y las teclas de flecha lo mueven.",
          },
          {
            id: "ch16-l2-s2",
            title: "Renderizado con DOM",
            content: "El display crea elementos DOM para cada celda y actor, y los posiciona con CSS. En cada frame, actualiza las posiciones de los actores. Tambien implementa scrolling para seguir al jugador en niveles mas grandes que la ventana.",
            codeExample: "function runAnimation(frameFunc) {\n  let lastTime = null;\n  function frame(time) {\n    if (lastTime != null) {\n      let timeStep = Math.min(time - lastTime, 100) / 1000;\n      if (frameFunc(timeStep) === false) return;\n    }\n    lastTime = time;\n    requestAnimationFrame(frame);\n  }\n  requestAnimationFrame(frame);\n}",
          },
        ],
        exercises: [
          {
            id: "ch16-l2-e1",
            type: "multiple-choice",
            question: "Que pasa cuando el jugador toca la lava?",
            options: [
              "El nivel se reinicia",
              "El jugador gana",
              "Nada",
              "El juego termina permanentemente",
            ],
            correctAnswer: "El nivel se reinicia",
            explanation: "Tocar lava reinicia el nivel actual. El jugador debe intentar de nuevo sin perder monedas recogidas globalmente.",
            xpReward: 15,
          },
          {
            id: "ch16-l2-e2",
            type: "fill-blank",
            question: "Para animaciones suaves a 60fps usamos ___.",
            options: ["requestAnimationFrame", "setInterval", "setTimeout", "animate"],
            correctAnswer: "requestAnimationFrame",
            explanation: "requestAnimationFrame sincroniza la animacion con el refresco de la pantalla del navegador para un rendimiento optimo.",
            xpReward: 15,
          },
        ],
      },
  ...
  },
  {
    ...
    lessons: [
      {
        id: "ch17-l1",
        title: "Formas y colores en Canvas",
        xpReward: 35,
        sections: [
          {
            id: "ch17-l1-s1",
            title: "El contexto 2D",
            content: "El elemento <canvas> proporciona una superficie de dibujo. Se obtiene un contexto 2D con getContext('2d'). El sistema de coordenadas empieza en (0,0) arriba a la izquierda. fillRect dibuja rectangulos rellenos, strokeRect dibuja contornos.",
            codeExample: "let canvas = document.querySelector('canvas');\nlet ctx = canvas.getContext('2d');\nctx.fillStyle = 'red';\nctx.fillRect(10, 10, 100, 50);\nctx.strokeStyle = 'blue';\nctx.strokeRect(10, 70, 100, 50);",
          },
          {
            id: "ch17-l1-s2",
            title: "Paths y arcos",
            content: "Para formas complejas se usan paths (trazados). beginPath() inicia un path, moveTo() y lineTo() definen segmentos, arc() dibuja arcos/circulos, y fill()/stroke() rellenan o trazan el path. closePath() cierra la forma.",
            codeExample: "let ctx = canvas.getContext('2d');\n// Triangulo\nctx.beginPath();\nctx.moveTo(50, 10);\nctx.lineTo(10, 70);\nctx.lineTo(90, 70);\nctx.closePath();\nctx.fill();\n\n// Circulo\nctx.beginPath();\nctx.arc(150, 40, 30, 0, Math.PI * 2);\nctx.fill();",
          },
        ],
        exercises: [
          {
          ...
          },
          {
            id: "ch17-l1-e2",
            type: "fill-blank",
            question: "Para dibujar un circulo completo usamos ctx.arc(x, y, radio, 0, Math.PI * ___).",
            options: ["2", "1", "3", "4"],
            correctAnswer: "2",
            explanation: "Un circulo completo tiene 2*PI radianes (360 grados). Math.PI * 2 dibuja el arco completo.",
            xpReward: 15,
          },
        ],
      },
      {
        id: "ch17-l2",
        title: "Transformaciones y animacion",
        xpReward: 40,
        sections: [
          {
            id: "ch17-l2-s1",
            title: "Transformaciones",
            content: "El canvas soporta transformaciones: translate() mueve el origen, rotate() rota el contexto, scale() escala el dibujo. save() guarda el estado actual y restore() lo recupera. Esto permite dibujar formas en diferentes posiciones y angulos sin recalcular coordenadas.",
            codeExample: "ctx.save();\nctx.translate(100, 100); // nuevo origen\nctx.rotate(Math.PI / 4); // rotar 45 grados\nctx.fillRect(-25, -25, 50, 50); // cuadrado rotado\nctx.restore(); // volver al estado original",
          },
          {
            id: "ch17-l2-s2",
            title: "Texto e imagenes",
            content: "fillText() y strokeText() dibujan texto. drawImage() dibuja imagenes (desde un elemento Image o img). Se puede dibujar solo una parte de la imagen (sprite sheets) especificando las coordenadas de origen y destino.",
        ...
        exercises: [
          {
            id: "ch17-l2-e1",
            type: "multiple-choice",
            question: "Que hacen save() y restore() en el canvas?",
            options: [
              "Guardan y restauran el estado de transformacion y estilos",
              "Guardan y cargan la imagen",
              "Crean y eliminan el canvas",
              "Pausan y reanudan la animacion",
            ],
            correctAnswer: "Guardan y restauran el estado de transformacion y estilos",
            explanation: "save() guarda el estado actual (transformaciones, estilos, clip) en una pila, y restore() lo recupera.",
            xpReward: 15,
          },
          {
            id: "ch17-l2-e2",
            type: "true-false",
            question: "translate() mueve permanentemente todos los dibujos futuros.",
            options: ["Verdadero", "Falso"],
            correctAnswer: "Falso",
            explanation: "El efecto de translate se puede revertir con restore(). Por eso se usa save() antes de transformar y restore() despues.",
            xpReward: 10,
          },
        ],
      },
    ...
    lessons: [
      {
        ...
        sections: [
          {
            ...
            content: "HTTP es un protocolo de peticion-respuesta. El cliente envia un request con un metodo (GET, POST, PUT, DELETE), headers y opcionalmente un body. El servidor responde con un status code (200 OK, 404 Not Found, etc.), headers y un body.",
          },
          {
            id: "ch18-l1-s2",
            title: "La Fetch API",
            content: "fetch() es la forma moderna de hacer peticiones HTTP desde JavaScript. Devuelve una promesa que se resuelve con un objeto Response. Debes llamar .json(), .text() o .blob() para leer el cuerpo de la respuesta. Se puede configurar el metodo, headers y body.",
        ...
        exercises: [
          ...
          },
          {
            id: "ch18-l1-e2",
            type: "multiple-choice",
            question: "Que status code indica que el recurso no fue encontrado?",
            options: ["404", "200", "500", "301"],
            correctAnswer: "404",
            explanation: "404 Not Found indica que el servidor no encontro el recurso solicitado. 200 es OK, 500 es error del servidor.",
            xpReward: 15,
          },
        ],
      },
        ...
        sections: [
          {
            ...
            content: "Los formularios (<form>) agrupan campos de entrada. Tipos comunes: <input type='text'>, <input type='password'>, <input type='checkbox'>, <select>, <textarea>. Cada campo tiene un name y value. El evento 'submit' se dispara al enviar el formulario.",
            codeExample: "<form id='miForm'>\n  <input type='text' name='nombre' />\n  <input type='email' name='email' />\n  <select name='pais'>\n    <option value='mx'>Mexico</option>\n    <option value='es'>Espana</option>\n  </select>\n  <button type='submit'>Enviar</button>\n</form>",
          },
          {
            id: "ch18-l2-s2",
            title: "Leer y validar formularios con JS",
            content: "JavaScript puede leer valores de campos con element.value, habilitar/deshabilitar campos, y prevenir el envio por defecto. FormData permite recopilar todos los valores del formulario facilmente. La validacion del lado del cliente mejora la experiencia del usuario.",
            codeExample: "let form = document.querySelector('#miForm');\nform.addEventListener('submit', event => {\n  event.preventDefault();\n  let data = new FormData(form);\n  console.log(data.get('nombre'));\n  console.log(data.get('email'));\n  \n  // O acceder directamente\n  console.log(form.elements.nombre.value);\n});",
          },
        ],
        exercises: [
          {
            id: "ch18-l2-e1",
            type: "fill-blank",
            question: "Para prevenir que un formulario se envie normalmente, usamos event.___().",
            options: ["preventDefault", "stopSubmit", "cancelEvent", "blockDefault"],
            correctAnswer: "preventDefault",
            explanation: "event.preventDefault() evita el comportamiento por defecto del formulario (recargar la pagina al enviar).",
            xpReward: 15,
          },
          {
            id: "ch18-l2-e2",
            type: "multiple-choice",
            question: "Que objeto facilita recopilar todos los datos de un formulario?",
            options: ["FormData", "FormObject", "InputData", "FormValues"],
            correctAnswer: "FormData",
            explanation: "new FormData(form) recoge automaticamente todos los campos con name del formulario en un objeto iterable.",
            xpReward: 15,
          },
        ],
      },
  ...
  },
  {
    ...
    lessons: [
      {
        id: "ch19-l1",
        title: "Componentes del editor",
        xpReward: 40,
        sections: [
          {
            id: "ch19-l1-s1",
            title: "Arquitectura por componentes",
            content: "El editor se construye con componentes reutilizables: PictureCanvas (la cuadricula de dibujo), ToolSelect (selector de herramienta), ColorSelect (selector de color), y SaveButton/LoadButton. Cada componente sabe como crear su DOM y actualizarse cuando cambia el estado.",
          },
          {
            id: "ch19-l1-s2",
            title: "Estado inmutable de la imagen",
            content: "La imagen se representa como un objeto Picture inmutable con un arreglo plano de pixeles. Cada 'dibujo' crea un nuevo objeto Picture en vez de modificar el anterior. Esto permite implementar undo facilmente guardando estados anteriores.",
            codeExample: "class Picture {\n  constructor(width, height, pixels) {\n    this.width = width;\n    this.height = height;\n    this.pixels = pixels;\n  }\n  pixel(x, y) {\n    return this.pixels[x + y * this.width];\n  }\n  draw(pixels) {\n    let copy = this.pixels.slice();\n    for (let {x, y, color} of pixels) {\n      copy[x + y * this.width] = color;\n    }\n    return new Picture(this.width, this.height, copy);\n  }\n}",
          },
        ],
        exercises: [
          {
          ...
          },
          {
            id: "ch19-l1-e2",
            type: "multiple-choice",
            question: "Por que se usa estado inmutable para la imagen?",
            options: [
              "Permite implementar undo guardando estados anteriores",
              "Las imagenes no se pueden modificar en JavaScript",
              "Es mas rapido que modificar en el lugar",
              "El canvas lo requiere",
            ],
            correctAnswer: "Permite implementar undo guardando estados anteriores",
            explanation: "Con estado inmutable, cada cambio crea una nueva copia. Guardando copias anteriores, se puede deshacer facilmente.",
            xpReward: 15,
          },
        ],
      },
      {
        ...
        sections: [
          {
            id: "ch19-l2-s1",
            title: "Herramientas: draw, rectangle, fill",
            content: "draw pinta pixeles individuales siguiendo el mouse. rectangle dibuja rectangulos arrastrando. fill (relleno) usa un algoritmo flood fill para pintar todos los pixeles conectados del mismo color. Cada herramienta es una funcion que recibe la posicion y el estado.",
          },
          {
            id: "ch19-l2-s2",
            title: "Guardar, cargar y undo",
            content: "El editor puede guardar la imagen como PNG usando canvas.toDataURL(). Cargar convierte una imagen en pixeles leyendola en un canvas temporal. Undo deshace el ultimo cambio restaurando el estado anterior del historial.",
            codeExample: "// Guardar como PNG\nfunction save(picture) {\n  let canvas = document.createElement('canvas');\n  canvas.width = picture.width;\n  canvas.height = picture.height;\n  let ctx = canvas.getContext('2d');\n  // dibujar pixeles...\n  let link = document.createElement('a');\n  link.href = canvas.toDataURL();\n  link.download = 'pixel-art.png';\n  link.click();\n}",
          },
        ],
        exercises: [
          {
            id: "ch19-l2-e1",
            type: "multiple-choice",
            question: "Que algoritmo usa la herramienta 'fill' para rellenar areas conectadas?",
            options: ["Flood fill", "Bubble sort", "Binary search", "BFS de grafos"],
            correctAnswer: "Flood fill",
            explanation: "Flood fill expande desde el pixel clickeado, pintando todos los pixeles vecinos del mismo color original.",
            xpReward: 15,
          },
          {
            id: "ch19-l2-e2",
            type: "fill-blank",
            question: "Para exportar un canvas como imagen usamos canvas.___().",
            options: ["toDataURL", "toImage", "exportPNG", "saveAs"],
            correctAnswer: "toDataURL",
            explanation: "canvas.toDataURL() devuelve una cadena data URL que contiene la imagen en formato PNG (por defecto).",
            xpReward: 15,
          },
        ],
      },
  ...
  },
  {
    ...
    lessons: [
      {
        id: "ch20-l1",
        title: "Node.js y el sistema de archivos",
        xpReward: 35,
        sections: [
          {
            id: "ch20-l1-s1",
            title: "Que es Node.js",
            content: "Node.js permite ejecutar JavaScript fuera del navegador. Usa el motor V8 de Chrome. Es ideal para servidores web, herramientas CLI y aplicaciones de red. No tiene acceso al DOM pero si al sistema de archivos, red, y procesos del SO.",
          },
          {
            id: "ch20-l1-s2",
            title: "El modulo fs (sistema de archivos)",
            content: "El modulo fs permite leer y escribir archivos. readFile lee un archivo, writeFile escribe contenido. Existen versiones sincronas (readFileSync) y asincronas (con callbacks o promesas). El modulo path ayuda a manipular rutas de archivos.",
            codeExample: "const {readFile, writeFile} = require('fs');\nconst {readFile: readFileP} = require('fs').promises;\n\n// Con callbacks\nreadFile('archivo.txt', 'utf8', (err, texto) => {\n  if (err) throw err;\n  console.log(texto);\n});\n\n// Con promesas (moderno)\nasync function leer() {\n  let texto = await readFileP('archivo.txt', 'utf8');\n  console.log(texto);\n}",
          },
        ],
        exercises: [
          {
          ...
          },
          {
            id: "ch20-l1-e2",
            type: "fill-blank",
            question: "Para leer archivos en Node.js usamos el modulo ___.",
            options: ["fs", "file", "io", "disk"],
            correctAnswer: "fs",
            explanation: "El modulo 'fs' (file system) proporciona funciones para interactuar con el sistema de archivos.",
            xpReward: 10,
          },
        ],
      },
      {
        id: "ch20-l2",
        title: "Servidores HTTP con Node",
        xpReward: 40,
        sections: [
          {
            id: "ch20-l2-s1",
            title: "Crear un servidor HTTP",
            content: "El modulo http permite crear servidores web. createServer recibe una funcion que se ejecuta con cada peticion. El objeto request tiene url y method. El objeto response permite enviar la respuesta con writeHead y end.",
          ...
          },
          {
            ...
            content: "Podemos construir un servidor que sirve archivos estaticos leyendolos del disco. Usamos la URL como ruta del archivo, verificamos que existe y que no intenta acceder fuera del directorio permitido (seguridad). Diferentes tipos de archivos necesitan diferentes Content-Types.",
            codeExample: "const {createReadStream} = require('fs');\nconst {stat} = require('fs').promises;\nconst path = require('path');\n\nhttp.createServer(async (req, res) => {\n  let filePath = '.' + req.url;\n  try {\n    let stats = await stat(filePath);\n    if (stats.isDirectory()) filePath += '/index.html';\n    res.writeHead(200);\n    createReadStream(filePath).pipe(res);\n  } catch (e) {\n    res.writeHead(404);\n    res.end('No encontrado');\n  }\n});",
          },
        ],
        exercises: [
          {
            id: "ch20-l2-e1",
            type: "multiple-choice",
            question: "Que metodo crea un servidor HTTP en Node.js?",
            options: ["http.createServer()", "http.newServer()", "http.listen()", "http.start()"],
            correctAnswer: "http.createServer()",
            explanation: "http.createServer() crea un nuevo servidor HTTP que ejecuta la funcion dada con cada peticion entrante.",
            xpReward: 15,
          },
          {
            id: "ch20-l2-e2",
            type: "fill-blank",
            question: "Para que el servidor escuche peticiones en el puerto 8000, llamamos server.___( 8000).",
            options: ["listen", "start", "open", "connect"],
            correctAnswer: "listen",
            explanation: "server.listen(puerto) hace que el servidor empiece a escuchar conexiones entrantes en el puerto especificado.",
            xpReward: 15,
          },
        ],
      },
  ...
  },
  {
    ...
    lessons: [
        ...
        sections: [
          {
            ...
            content: "El sitio web de intercambio de habilidades permite a las personas proponer charlas y comentar en las de otros. El servidor almacena charlas en memoria y las sirve a traves de una API REST. El cliente se actualiza en tiempo real usando long polling.",
          },
          {
            id: "ch21-l1-s2",
            title: "API REST del servidor",
            content: "El servidor tiene endpoints para las charlas: GET /talks obtiene todas, PUT /talks/titulo crea o actualiza una, DELETE /talks/titulo la elimina, y POST /talks/titulo/comments agrega un comentario. Las respuestas son JSON.",
            codeExample: "// Crear/actualizar charla\n// PUT /talks/Unittesting\n// Content-Type: application/json\n// {\"presenter\": \"Ana\",\n//  \"summary\": \"Como escribir pruebas\"}\n\n// Agregar comentario\n// POST /talks/Unittesting/comments\n// Content-Type: application/json\n// {\"author\": \"Bob\",\n//  \"message\": \"Gran tema!\"}",
          },
        ],
        exercises: [
          {
          ...
          },
          {
            id: "ch21-l1-e2",
            type: "multiple-choice",
            question: "Que metodo HTTP se usa para crear o actualizar un recurso?",
            options: ["PUT", "GET", "DELETE", "HEAD"],
            correctAnswer: "PUT",
            explanation: "PUT envia datos al servidor para crear o reemplazar completamente un recurso en la URL especificada.",
            xpReward: 15,
          },
        ],
      },
      {
        id: "ch21-l2",
        title: "El cliente y long polling",
        xpReward: 45,
        sections: [
          {
            id: "ch21-l2-s1",
            title: "Long polling para tiempo real",
            content: "Long polling es una tecnica donde el cliente hace una peticion al servidor y el servidor no responde hasta que hay datos nuevos (o pasa un timeout). Cuando el cliente recibe la respuesta, inmediatamente hace otra peticion. Esto simula comunicacion en tiempo real sin WebSockets.",
            codeExample: "async function pollTalks(update) {\n  let tag = undefined;\n  for (;;) {\n    let response;\n    try {\n      response = await fetch('/talks', {\n        headers: tag ?\n          {'If-None-Match': tag, 'Prefer': 'wait=90'} : {}\n      });\n    } catch (e) {\n      // Error de red, reintentar despues de pausa\n      await new Promise(r => setTimeout(r, 500));\n      continue;\n    }\n    if (response.status === 304) continue;\n    tag = response.headers.get('ETag');\n    update(await response.json());\n  }\n}",
          },
          {
            id: "ch21-l2-s2",
            title: "Renderizado del cliente",
            content: "El cliente renderiza la lista de charlas y un formulario para proponer nuevas. Cada charla muestra su titulo, presentador, resumen y comentarios. Los cambios del servidor se aplican re-renderizando solo lo que cambio. Todo funciona sin framework, con JavaScript puro.",
          },
        ],
        exercises: [
          {
            id: "ch21-l2-e1",
            type: "multiple-choice",
            question: "Que es long polling?",
            options: [
              "El servidor mantiene la peticion abierta hasta tener datos nuevos",
              "El cliente envia peticiones cada milisegundo",
              "Una conexion permanente bidireccional",
              "Un tipo de base de datos",
            ],
            correctAnswer: "El servidor mantiene la peticion abierta hasta tener datos nuevos",
            explanation: "En long polling, el servidor retiene la respuesta hasta que hay actualizaciones, luego el cliente inmediatamente hace otra peticion.",
            xpReward: 15,
          },
          {
            id: "ch21-l2-e2",
            type: "fill-blank",
            question: "El header ___ permite al servidor saber que version de datos tiene el cliente.",
            options: ["ETag", "Cookie", "Authorization", "Cache-Control"],
            correctAnswer: "ETag",
            explanation: "ETag es un identificador de version. El cliente lo envia en If-None-Match para que el servidor sepa si tiene datos actualizados.",
            xpReward: 15,
          },
        ],
      },
